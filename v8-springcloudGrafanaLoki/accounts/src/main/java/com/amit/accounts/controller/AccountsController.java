...
import com.amit.accounts.constants.AccountsConstants;
...
import com.amit.accounts.dto.ResponseDto;
import com.amit.accounts.service.IAccountsService;
...
@Tag(
        name = "CRUD REST APIs for Accounts in AmitBank",
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside AmitBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @RateLimiter(name = "getEnvDetails", fallbackMethod = "getJavaVersion" )
